...
export default {
  ...
  com_ui_pay_per_call: 'Welcome to the cosmic hub of AI gossip! Here, chats come à la carte, not tethered to the tyranny of monthly fees. Join the riddle revolution—one conversation at a time!',
  com_ui_new_footer: 'Gathering all the AI gossip under one cosmic chat umbrella!',
  com_ui_enter: 'Enter',
